...
//reads database stored in database file
(async () => {
      db = await open({
...
//gets all cars in csv file
app.get('/getAll', (req, res) => {
    getAll(res)
});

//gets information for a single car by car id 
app.get('/car/:id', (req, res) => {
    getCar(req, res)
});

//insert new car using JSON object 
...
//insert new car using query parameters
...
//updates car entry using JSON object
app.patch('/updateJSON', (req, res) => {
    updateCar(req, res)
    res.send('PATCH request')
});

//updates car entry using query parameters
